...
static unsigned int gpioLED = 50; ///< hard coding the LED gpio for this example to P9_14 (GPIO49)
static unsigned int gpioLED2 = 14; ///< hard coding the LED gpio for this example to P9_26 (GPIO15)
static unsigned int gpioButton = 49;   ///< hard coding the button gpio for this example to P9_23 (GPIO115)
